...
internal sealed class RabbitMQChannelPool : IRabbitMQChannelPool, IDisposable
{
    ...
    private readonly ConcurrentQueue<IModel> _pooledChannels = new();
    ...
    /// <inheritdoc/>
    public ValueTask<IModel> RentAsync(CancellationToken cancellationToken = default)
    {
        ThrowIfDisposed();
        ...
        async ValueTask<IModel> InnerRentAsync(CancellationToken cancellationToken = default)
        {
